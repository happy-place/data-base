...
//			attendColumnDescriptor.setCompressionType(Algorithm.SNAPPY);
     ...
     * 展示内容
     */
    public void testPublishContent(WeiBoNewHandler wb) {
        wb.publishContent("0001", "今天买了一包空气，送了点薯片，非常开心！！");
        wb.publishContent("0001", "今天天气不错。");
    }

    public void testAddAttend(WeiBoNewHandler wb) {
        wb.publishContent("0008", "准备下课！");
        wb.publishContent("0009", "准备关机！");
        wb.addAttends("0001", "0008", "0009");
    }

    public void testRemoveAttend(WeiBoNewHandler wb) {
        wb.removeAttends("0001", "0008");
    }

    public void testShowMessage(WeiBoNewHandler wb) {
    ...
    public static void main(String[] args) {
        WeiBoNewHandler weibo = new WeiBoNewHandler();
        weibo.initTable();
