...
public class OrderCachedBean implements WritableComparable<OrderCachedBean> {
    ...
    public OrderCachedBean() {
        super();
    }
        

    public OrderCachedBean(String orderId, String goodsId, String goodsName,
                           int amount) {
        super();
...
//    @Override
    public int compareTo(OrderCachedBean o) {
