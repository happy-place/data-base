...
public class LocationPartitonerRunner {

    public static void main(String[] args) throws Exception {

        args = new String[]{"api-test/hadoop-test/test5/in", "api-test/hadoop-test/test5/out"};
        ...
        job.setJarByClass(LocationPartitonerRunner.class);
