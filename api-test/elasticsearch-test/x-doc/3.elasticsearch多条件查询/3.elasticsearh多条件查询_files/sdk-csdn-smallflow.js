(function(window,document/*,undefined*/){
  ...
  xhrRecall.addEventListener("load",function(){
    ...
    var timer=setInterval(function renderInit(){
      ...
      if(!(marker=divs[2]))return;clearInterval(timer); // TODO delay to next render phase
      ...
      marker.insertAdjacentElement("beforebegin",div);div.addEventListener("click",function(){
